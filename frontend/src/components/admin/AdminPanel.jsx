...
const AdminPanel = () => {
  ...
  const users = [
    { name: 'Ali', email: 'ali@gmail.com', score: 90 },
    { name: 'Vali', email: 'vali@gmail.com', score: 85 },
  ];
            ...
            <table className="min-w-full table-auto">
              <thead className="bg-gray-200">
                <tr>
                  ...
                  <th className="px-2 sm:px-4 py-2">To'plagan ballari</th>
                </tr>
              </thead>
              <tbody>
                {users.map((user, index) => (
                  <tr key={index} className="bg-gray-100">
                    ...
                    <td className="px-2 sm:px-4 py-2">{user.score}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <table className="min-w-full table-auto mt-4">
              <thead className="bg-gray-200">
                <tr>
                  ...
                  <th className="px-2 sm:px-4 py-2">Savol</th>
                  <th className="px-2 sm:px-4 py-2">Amallar</th>
                </tr>
              </thead>
              <tbody>
                {questions.map((question, index) => (
                  <tr key={index} className="bg-gray-100">
                    <td className="px-2 sm:px-4 py-2">{question.id}</td>
                    <td className="px-2 sm:px-4 py-2">{question.question}</td>
